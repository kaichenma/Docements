...
object Preprocessor {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df: DataFrame = spark
      ...
      .csv("/Users/kaichenma/Documents/copies/TP_Spark/funding-successful-projects-on-kickstarter/train.csv")
    ...
    dfFiltered.write.mode(SaveMode.Overwrite).parquet("/Users/kaichenma/Documents/copies/TP_Spark/result")
